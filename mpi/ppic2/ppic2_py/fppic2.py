...
isign = 0
ppois22(qt,fxyt,isign,ffc,ax,ay,affp,we,nx,ny,kstrt,nye,kxp,nyh)
...
# modifies fxyt
   dtimer(dtime,itime,-1)
   isign = 1
   wppfft2r2(fxye,fxyt,bs,br,isign,ntpose,mixup,sct,ttp,indx,indy,kstrt,
...
# push particles: updates part, wke, and ihole
   wke[0] = 0.0
   dtimer(dtime,itime,-1)
   ppgpush2l(part,fxye,edges,npp,noff,ihole,qbme,dt,wke,nx,ny,idimp,
