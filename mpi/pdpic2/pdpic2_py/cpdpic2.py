...
isign = 0
cppepoisp23(dcut,cur,isign,ffe,ax,ay,affp,wpm,ci,wf,nx,ny,kstrt,nye,kxp,
            nyh)
...
# deposit current with standard procedure: updates cue and ihole
   ...
   cue.fill(0.0)
   cppgjpost2l(part,cue,edges,npp,noff,ihole,qme,zero,nx,ny,idimp,npmax,
...
# procedure: updates fxyze, modifies fxyt
   dtimer(dtime,itime,-1)
   isign = 1
   cwppfft2r3(fxyze,fxyt,bs,br,isign,ntpose,mixup,sct,ttp,indx,indy,
...
# modifies cue
   dtimer(dtime,itime,-1)
   isign = -1
   cwppfft2r3(cue,cut,bs,br,isign,ntpose,mixup,sct,ttp,indx,indy,kstrt,
...
# updates bxyze, modifies bxyt
   dtimer(dtime,itime,-1)
   isign = 1
   cwppfft2r3(bxyze,bxyt,bs,br,isign,ntpose,mixup,sct,ttp,indx,indy,
              kstrt,nvp,nxeh,nye,kxp,kyp,nypmx,nxhy,nxyh)
   dtimer(dtime,itime,1)
   time = float(dtime)
   tfft[0] = tfft[0] + time
...
# with standard procedure: updates dcut, amut, modifies dcu, amu
   dtimer(dtime,itime,-1)
   isign = -1
   cwppfft2r3(dcu,dcut,bs,br,isign,ntpose,mixup,sct,ttp,indx,indy,kstrt,
              nvp,nxeh,nye,kxp,kyp,nypmx,nxhy,nxyh)
   tfft[1] = tfft[1] + ttp[0]
   cwppfft2rn(amu,amut,bs,br,ss,isign,ntpose,mixup,sct,ttp,indx,indy,
...
# procedure: updates cus, modifies cur
   dtimer(dtime,itime,-1)
   isign = 1
   cwppfft2r3(cus,cur,bs,br,isign,ntpose,mixup,sct,ttp,indx,indy,kstrt,
              nvp,nxeh,nye,kxp,kyp,nypmx,nxhy,nxyh)
   dtimer(dtime,itime,1)
   time = float(dtime)
   tfft[0] = tfft[0] + time
...
# with standard procedure: updates cue, dcu, amu
      ...
      cppgdcjpost2l(part,exyze,bxyze,npp,noff,cue,dcu,amu,qme,qbme,dt,
...
# modifies cue
      dtimer(dtime,itime,-1)
      isign = -1
      cwppfft2r3(cue,cut,bs,br,isign,ntpose,mixup,sct,ttp,indx,indy,
                 kstrt,nvp,nxeh,nye,kxp,kyp,nypmx,nxhy,nxyh)
      dtimer(dtime,itime,1)
      time = float(dtime)
      tfft[0] = tfft[0] + time
...
# with standard procedure: updates dcut, amut, modifies dcu, amu
      dtimer(dtime,itime,-1)
      isign = -1
      cwppfft2r3(dcu,dcut,bs,br,isign,ntpose,mixup,sct,ttp,indx,indy,
                 kstrt,nvp,nxeh,nye,kxp,kyp,nypmx,nxhy,nxyh)
      tfft[1] = tfft[1] + ttp[0]
      cwppfft2rn(amu,amut,bs,br,ss,isign,ntpose,mixup,sct,ttp,indx,indy,
                 kstrt,nvp,nxeh,nye,kxp,kyp,nypmx,mdim,nxhy,nxyh)
...
# procedure: updates cus, modifies cur
      dtimer(dtime,itime,-1)
      isign = 1
      cwppfft2r3(cus,cur,bs,br,isign,ntpose,mixup,sct,ttp,indx,indy,
                 kstrt,nvp,nxeh,nye,kxp,kyp,nypmx,nxhy,nxyh)
      dtimer(dtime,itime,1)
      time = float(dtime)
      tfft[0] = tfft[0] + time
...
# push particles: updates part, wke, and ihole
   wke[0] = 0.0
   dtimer(dtime,itime,-1)
   cppgbpush23l(part,exyze,bxyze,edges,npp,noff,ihole,qbme,dt,dt,wke,nx,
