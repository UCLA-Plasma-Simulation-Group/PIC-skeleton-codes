...
! SSE2 function
            ...
            call csse2mmaxwel2(exyz,bxyz,cue,ffc,ci,dt,wf,wm,nx,ny,nxeh,&
     &nye,nxh,nyh)
         endif
      endif
      call dtimer(dtime,itime,1)
...
! SSE2 function
         ...
         call csse2mpois23(qe,fxyze,isign,ffc,ax,ay,affp,we,nx,ny,nxeh, &
     &nye,nxh,nyh)
      endif
      call dtimer(dtime,itime,1)
      time = real(dtime)
...
! SSE2 function
         ...
         call csse2memfield2(fxyze,exyz,ffc,isign,nx,ny,nxeh,nye,nxh,nyh&
     &)
      endif
...
! SSE2 function
         ...
         call csse2memfield2(bxyze,bxyz,ffc,isign,nx,ny,nxeh,nye,nxh,nyh&
     &)
      endif
      call dtimer(dtime,itime,1)
      time = real(dtime)
...
! SSE2 function
         ...
         call csse2wfft2rm3(fxyze,isign,mixup,sct,indx,indy,nxeh,nye,   &
     &nxhy,nxyh)
      endif
      call dtimer(dtime,itime,1)
      time = real(dtime)
...
! SSE2 function
!        else if (kvec==2) then
!           call csse2grbppush23lt(ppartt,fxyze,bxyze,kpic,qbme,dt,dth, &
...
! SSE2 function
            ...
            call csse2grbppushf23lt(ppartt,fxyze,bxyze,kpic,ncl,ihole,  &
...
! SSE2 function
     ...
     &qbme,dt,dth,wke,idimp,nppmx0,nx,ny,mx,my,nxe,nye,mx1,mxy1,ntmax,  &
     &irc)
         endif
      endif
      call dtimer(dtime,itime,1)
