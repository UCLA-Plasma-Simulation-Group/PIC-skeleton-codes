...
/*--------------------------------------------------------------------*/
void cgppcbguard2l_(unsigned long *gp_fxyz, unsigned long *gp_fxyze,
                    unsigned long *gp_scs, float *scs, float *scr,
                    int *nx, int *nyp, int *kstrt, int *nvp, int *ndim,
                    int *nxe, int *nypmx, int *nxvh, int *kypd) {
   float complex *g_fxyz;
   float *g_fxyze, *g_scs;
   g_fxyz = (float complex *)*gp_fxyz;
   g_fxyze = (float *)*gp_fxyze;
   g_scs = (float *)*gp_scs;
   cgppcbguard2l(g_fxyz,g_fxyze,g_scs,scs,scr,*nx,*nyp,*kstrt,*nvp,
