...
!
      interface
         subroutine cppgjppost2l(ppart,cu,kpic,noff,qm,dt,nppmx,idimp,nx&
...
!
      interface
         subroutine cppgmjppost2l(ppart,amu,kpic,noff,qm,nppmx,idimp,mx,&
...
!
      interface
         subroutine cppgdjppost2l(ppart,fxy,bxy,dcu,amu,kpic,noff,nyp,qm&
...
!
      interface
         subroutine cppgdcjppost2l(ppart,fxy,bxy,cu,dcu,amu,kpic,noff,  &
...
!
      interface
         subroutine cmppbbpoisp23(cu,bxy,ffc,ci,wm,nx,ny,kstrt,nyv,kxp, &
     &nyhd)
         implicit none
...
!
      interface
         subroutine cmppdcuperp23(dcu,amu,nx,ny,kstrt,nyv,kxp)
         implicit none
         integer, intent(in) :: nx, ny, kstrt, nyv, kxp
...
!
      interface
         subroutine cmppadcuperp23(dcu,amu,nx,ny,kstrt,nyv,kxp)
         implicit none
         integer, intent(in) :: nx, ny, kstrt, nyv, kxp
!        complex, dimension(3,nyv,kxp), intent(inout) :: dcu
         complex, dimension(*), intent(inout) :: dcu
...
!
      interface
         subroutine cmppepoisp23(dcu,exy,isign,ffe,ax,ay,affp,wp0,ci,wf,&
...
!
      interface
         subroutine cwppfft2rmn(f,g,bs,br,ss,isign,ntpose,mixup,sct,ttp,&
...
!
      interface
         subroutine cppfft2rmnxx(f,ss,isign,mixup,sct,indx,indy,kstrt,  &
...
!
      interface
         subroutine cppfft2rmnxy(g,isign,mixup,sct,indx,indy,kstrt,kxpi,&
...
!
      interface
         subroutine cmppswapc2n(f,s,isign,nxh,kypi,kypt,nxvh,kypd,ndim)
         implicit none
