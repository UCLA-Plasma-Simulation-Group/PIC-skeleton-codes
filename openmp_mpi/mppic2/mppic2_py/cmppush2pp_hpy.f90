...
!
      interface
         subroutine cpppcheck2l(ppart,kpic,noff,nyp,idimp,nppmx,nx,mx,  &
     &my,mx1,myp1,irc)
         implicit none
...
!
      interface
         subroutine cppgppush2l(ppart,fxy,kpic,noff,nyp,qbm,dt,ek,nx,ny,&
...
!
      interface
         subroutine cppgppushf2l(ppart,fxy,kpic,ncl,ihole,noff,nyp,qbm, &
...
!
      interface
         subroutine cmppois22(q,fxy,isign,ffc,ax,ay,affp,we,nx,ny,kstrt,&
     &nyv,kxp,nyhd)
         implicit none
...
!
      interface
         subroutine cwppfft2rm2(f,g,bs,br,isign,ntpose,mixup,sct,ttp,   &
...
!
      interface
         subroutine cppfft2rm2xx(f,isign,mixup,sct,indx,indy,kstrt,kypi,&
     &kypp,nxvh,kypd,nxhyd,nxyhd)
         implicit none
         integer, intent(in) :: isign, indx, indy, kstrt, kypi, kypp
         integer, intent(in) :: nxvh, kypd, nxhyd, nxyhd
...
!
      interface
         subroutine cppfft2rm2xy(g,isign,mixup,sct,indx,indy,kstrt,kxpi,&
     &kxpp,nyv,kxp,nxhyd,nxyhd)
         implicit none
         integer, intent(in) :: isign, indx, indy, kstrt, kxpi, kxpp
         integer, intent(in) :: nyv, kxp, nxhyd, nxyhd
