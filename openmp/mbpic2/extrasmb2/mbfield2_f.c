/* C Library for Skeleton 2-1/2D Electromagnetic OpenMP PIC Code field */
/* diagnostics                                                         */
...
void mavpot23_(float complex *bxy, float complex *axy, int *nx, int *ny,
               int *nxvh, int *nyv);

void mavrpot23_(float complex *axy, float complex *bxy,
...
void cmavpot23(float complex bxy[], float complex axy[], int nx, int ny,
               int nxvh, int nyv) {
   mavpot23_(bxy,axy,&nx,&ny,&nxvh,&nyv);
   return;
}
...
void cmavrpot23(float complex axy[], float complex bxy[],
                ...
                int nyv, int nxhd, int nyhd) {
   mavrpot23_(axy,bxy,ffc,&ci,&nx,&ny,&nxvh,&nyv,&nxhd,&nyhd);
   return;
}
