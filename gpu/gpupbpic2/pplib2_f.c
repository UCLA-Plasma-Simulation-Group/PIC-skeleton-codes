...
void pppncguard2l_(float *scs, float *scr, int *kstrt, int *nvp,
                   int *nxv);

void pppnaguard2l_(float *scs, float *scr, int *kstrt, int *nvp,
                   int *nxv);
...
void cpppncguard2l(float scs[], float scr[], int kstrt, int nvp,
                   int nxv) {
   pppncguard2l_(scs,scr,&kstrt,&nvp,&nxv);
   return;
}
...
void cpppnaguard2l(float scs[], float scr[], int kstrt, int nvp,
                   int nxv) {
   pppnaguard2l_(scs,scr,&kstrt,&nvp,&nxv);
   return;
}
