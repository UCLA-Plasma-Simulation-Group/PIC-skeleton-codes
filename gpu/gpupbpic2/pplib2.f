...
c PPPNCGUARD2L sends/receives guard cells in y for scalar array, linear
c              interpolation, and distributed data with non-uniform
c              partition.  for copying guard cells.
c PPPNAGUARD2L sends/receives guard cells in y for scalar array, linear
c              interpolation, and distributed data with non-uniform
c              partition.  for adding guard cells.
