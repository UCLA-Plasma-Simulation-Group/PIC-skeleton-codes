...
!
      interface
         subroutine cgmjpost2l(part,amu,qm,nop,idimp,nxv,nyv)
         implicit none
         integer, intent(in) :: nop, idimp, nxv, nyv
         real, intent(in) :: qm
!        real, dimension(idimp,nop), intent(in) :: part
...
!
      interface
         subroutine cgdjpost2l(part,fxy,bxy,dcu,amu,qm,qbm,dt,idimp,nop,&
     &nxv,nyv)
         implicit none
...
!
      interface
         subroutine cgdcjpost2l(part,fxy,bxy,cu,dcu,amu,qm,qbm,dt,idimp,&
     &nop,nxv,nyv)
         implicit none
         integer, intent(in) :: idimp, nop, nxv, nyv
         real, intent(in) :: qm, qbm, dt
...
!
      interface
         subroutine cbbpois23(cu,bxy,ffc,ci,wm,nx,ny,nxvh,nyv,nxhd,nyhd)
         implicit none
...
!
      interface
         subroutine cdcuperp23(dcu,amu,nx,ny,nxvh,nyv)
         implicit none
         integer, intent(in) :: nx, ny, nxvh, nyv
...
!
      interface
         subroutine cadcuperp23(dcu,amu,nx,ny,nxvh,nyv)
         implicit none
         integer, intent(in) :: nx, ny, nxvh, nyv
!        real, dimension(3,2*nxvh,nyv), intent(inout) :: dcu
         real, dimension(*), intent(inout) :: dcu
...
!
      interface
         subroutine cepois23(dcu,exy,isign,ffe,ax,ay,affp,wp0,ci,wf,nx, &
...
!
      interface
         subroutine cwfft2rn(f,ss,isign,mixup,sct,indx,indy,nxhd,nyd,   &
     &ndim,nxhyd,nxyhd)
         implicit none
