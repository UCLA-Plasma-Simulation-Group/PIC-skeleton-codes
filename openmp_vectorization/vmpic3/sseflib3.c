...
/*--------------------------------------------------------------------*/
void sse_f4allocatex_(unsigned long *sp_f, int *ndim, int *nx, int *ny,
                      int *nz, int *nd, int *irc) {
/* allocate aligned 4d real memory, assign data   */
/* pointer to Fortran pointer object sp_f         */
/* nd = (1,2) = (default,double precision)        */
/* This procedure needs an interface in Fortran90 */
/* interface                                                */
...
/*--------------------------------------------------------------------*/
void sse_c3allocatex_(unsigned long *sp_c, int *nx, int *ny,  int *nz,
                      int *nd, int *irc) {
