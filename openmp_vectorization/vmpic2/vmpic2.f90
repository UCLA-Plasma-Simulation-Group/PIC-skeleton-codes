...
! SSE2 function
         ...
         call csse2mpois22(qe,fxye,isign,ffc,ax,ay,affp,we,nx,ny,nxeh,  &
     &nye,nxh,nyh)
      endif
      call dtimer(dtime,itime,1)
      time = real(dtime)
...
! SSE2 function
         ...
         call csse2wfft2rm2(fxye,isign,mixup,sct,indx,indy,nxeh,nye,nxhy&
     &,nxyh)
      endif
      call dtimer(dtime,itime,1)
      time = real(dtime)
...
! SSE2 function
!     else if (kvec==2) then
!        call csse2gppush2lt(ppartt,fxye,kpic,qbme,dt,wke,idimp,nppmx0, &
...
! SSE2 function
         ...
         call csse2gppushf2lt(ppartt,fxye,kpic,ncl,ihole,qbme,dt,wke,   &
