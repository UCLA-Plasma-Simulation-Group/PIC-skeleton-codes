...
!
      interface
         subroutine ckncgjppostf3lt(ppart,cu,kpic,ncl,ihole,qm,dt,nppmx,&
...
!
      interface
         subroutine ckncgrjppostf3lt(ppart,cu,kpic,ncl,ihole,qm,dt,ci,  &
     &nppmx,idimp,nx,ny,nz,mx,my,mz,nxv,nyv,nzv,mx1,my1,mxyz1,ntmax,irc)
         implicit none
         integer, intent(in) :: nppmx, idimp, nx, ny, nz, mx, my, mz
         integer, intent(in) :: nxv, nyv, nzv, mx1, my1, mxyz1, ntmax
         integer, intent(inout) :: irc
...
!
      interface
         subroutine cknc2gjppost3lt(ppart,cu,kpic,qm,dt,nppmx,idimp,nx, &
...
!
      interface
         subroutine cknc2grjppost3lt(ppart,cu,kpic,qm,dt,ci,nppmx,idimp,&
     &nx,ny,nz,mx,my,mz,nxv,nyv,nzv,mx1,my1,mxyz1,ipbc)
         implicit none
         integer, intent(in) :: nppmx, idimp, nx, ny, nz, mx, my, mz
         integer, intent(in) :: nxv, nyv, nzv, mx1, my1, mxyz1, ipbc
...
!
      interface
         subroutine ckncmcuperp3(cu,nx,ny,nz,nxvh,nyv,nzv)
         implicit none
...
!
      interface
         subroutine ckncmibpois33(cu,bxyz,ffc,ci,wm,nx,ny,nz,nxvh,nyv,  &
     &nzv,nxhd,nyhd,nzhd)
         implicit none
         integer, intent(in) :: nx, ny, nz, nxvh, nyv, nzv
         integer, intent(in) :: nxhd, nyhd, nzhd
...
!
      interface
         subroutine ckncmmaxwel3(exyz,bxyz,cu,ffc,ci,dt,wf,wm,nx,ny,nz, &
...
!
      interface
         subroutine ckncmemfield3(fxyz,exyz,ffc,isign,nx,ny,nz,nxvh,nyv,&
     &nzv,nxhd,nyhd,nzhd)
         implicit none
         integer, intent(in) :: isign, nx, ny, nz, nxvh, nyv, nzv
         integer, intent(in) :: nxhd, nyhd, nzhd
